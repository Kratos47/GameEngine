...
Image::Image(Image::Name _imageName, TextureNode*_pText, Rect _rect)
{
...
{
	this->imageName = _imageName;
	this->pText = Texture::FindTex(_textName);
	this->imageRect = _rect;
}

void Image::Set(Image::Name _imageName, TextureNode*_pText, Rect _rect)
{
	this->imageName = _imageName;
	this->pText = _pText;
	this->imageRect = _rect;
